...
// Version: 4.0.0 - Updated to use new API route with full features restored
// Date: 2024-12-18
...
export default function AdminUsersPage() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      // Fetch ALL users from API (paginate if needed)
      let allUsers: User[] = [];
      let page = 1;
      let hasMore = true;
      ...
      while (hasMore) {
        ...
        // Safety limit: stop after 50 pages (5000 users)
        if (page > 50) break;
      }
