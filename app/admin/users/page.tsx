...
export default function AdminUsersPage() {
  ...
  // ========================================================================
  // FETCH USERS VIA API ROUTE - useCallback to prevent recreation
  // ========================================================================
  ...
  // ========================================================================
  // FETCH ALERT ORGANIZATIONS - useCallback
  // ========================================================================

  const fetchAlertOrganizations = useCallback(async () => {
    try {
      ...
      console.error('[Admin] Error fetching alert organizations:', err);
    }
  }, []);

  // ========================================================================
  // SINGLE useEffect - Runs once on mount and when dependencies change
  // ========================================================================
  ...
  }, [authLoading, user, fetchUsers, fetchAlertOrganizations, router]);

  // ========================================================================
  // DEBOUNCED SEARCH - Separate useEffect for search only
  // ========================================================================
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      // This will trigger the main useEffect above to refetch
