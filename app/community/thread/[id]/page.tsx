...
import { ArrowLeft, Loader2, Flag, Mail, Edit, Trash2 } from 'lucide-react';
...
export default function ThreadPage() {
  ...
  const handleDeleteThread = async () => {
    if (!confirm('Delete this thread?\n\nThis will hide it from public view. Admins can restore it later if needed.')) {
      return;
    }
    ...
    try {
      ...
      alert('Something went wrong while deleting the thread.');
    }
  };
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link 
            ...
            className="inline-flex items-center gap-2 bg-gabriola-green text-white px-6 py-3 rounded-lg font-bold hover:bg-gabriola-green-dark cursor-pointer touch-manipulation"
          >
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <Link 
          ...
          className="inline-flex items-center gap-2 text-gabriola-green hover:underline mb-8 text-lg font-medium cursor-pointer touch-manipulation"
        >
          <ArrowLeft className="w-5 h-5" />
          Back to Forum
        </Link>
          ...
          <div className="flex gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center justify-between pt-6 border-t">
                ...
                {/* Report, Edit, and Delete buttons */}
                <div className="flex items-center gap-3">
                  {/* Edit button - only for thread owner */}
                  {isOwnPost && (
                    <>
                      <button
                        onClick={() => setShowEditModal(true)}
                        className="flex items-center gap-2 px-4 py-2 bg-blue-100 hover:bg-blue-600 hover:text-white text-blue-700 rounded-lg transition"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-600 hover:text-white text-red-700 rounded-lg transition"
                      >
